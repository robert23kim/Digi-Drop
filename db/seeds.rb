...
collectibles = [
    ...
    {:name => 'Crypterior #2629', :rarity => 'SR', :url => 'https://lh3.googleusercontent.com/cFRNM6EtgNL38o8D4GRED3Jge0nWAb092BOz8xjvewBwFe8qkdrUxbbOME4OpaadOUJia1owiR2rOGPxVVRb7m8tsqo-TqA3ymu6jw=s0', :value => 108000.00},
    ...
    {:name => 'Infected Caterpie', :rarity => 'SR', :url => 'https://lh3.googleusercontent.com/f3dfThFVPfFsLlYtMejTtTCKpENaQYsRNh0LvicSBwFRKbQgvnhYP6afLFpvCA8wRhftG_psPo0mulb2zWbdUjwMqaxgWc_2_eov=s992', :value => 70000.00},
]
...
cases = [
    {:name => 'Featured', :url => 'https://lh3.googleusercontent.com/cFRNM6EtgNL38o8D4GRED3Jge0nWAb092BOz8xjvewBwFe8qkdrUxbbOME4OpaadOUJia1owiR2rOGPxVVRb7m8tsqo-TqA3ymu6jw=s0', :value => 10.00},
    ...
    {:name => 'infectedpokemon', :url => 'https://i.imgur.com/RxOjBTC.png', :value => 10.00},
]
